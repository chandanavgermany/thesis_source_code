...
static PyObject *__pyx_f_9Optimizer_11Tabu_Search_18_generate_neighbor_generate_neighbor(PyObject *, double, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_f_9Optimizer_11Tabu_Search_18_generate_neighbor_generate_neighbor(PyObject *__pyx_v_solution, double __pyx_v_probability_change_machine, __Pyx_memviewslice __pyx_v_dependency_matrix_index_encoding, __Pyx_memviewslice __pyx_v_required_machine_matrix, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":11
 * @cython.nonecheck(False)
 * cpdef generate_neighbor(solution, double probability_change_machine, int[:, ::1] dependency_matrix_index_encoding, int[:, ::1] required_machine_matrix):
 *     cdef int[:, ::1] result_operation_2d_array = np.copy(solution.operation_2d_array)             # <<<<<<<<<<<<<<
 *     cdef int[::1] operation, usable_machines
 ...
 */
  ...
  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":16
 ...
 */
  ...
  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":17
 *     cdef double[::1] makespans
 *     lower_index = 0
 *     upper_index = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":22
 * 
 *         random_index = np.random.randint(0, result_operation_2d_array.shape[0])
 *         operation = result_operation_2d_array[random_index]             # <<<<<<<<<<<<<<
 *         job_id = operation[0]
 ...
 */
    ...
    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":31
 * 
 *         lower_index = 0 if lower_index < 0 else lower_index + 1
 *         upper_index = random_index + 1             # <<<<<<<<<<<<<<
 *         while upper_index < result_operation_2d_array.shape[0] and not (
 ...
 */
    ...
    if (__pyx_t_6) {
      ...
      /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":37
 * 
 *         if upper_index >= result_operation_2d_array.shape[0] - 1:
 *             upper_index = upper_index - 2             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
  ...
  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":42
 * 
 *     result_operation_2d_array = np.delete(result_operation_2d_array, random_index, axis=0)
 *     placement_index = random_index             # <<<<<<<<<<<<<<
 *     while placement_index == random_index:
 ...
 */
  ...
  if (__pyx_t_6) {
    ...
    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":47
 * 
 *     if np.random.random_sample() < probability_change_machine:
 *         i = dependency_matrix_index_encoding[operation[0], operation[1]]             # <<<<<<<<<<<<<<
 *         operation[3] = np.random.choice(required_machine_matrix[i])
...
static PyObject *__pyx_pw_9Optimizer_11Tabu_Search_18_generate_neighbor_1generate_neighbor(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_9Optimizer_11Tabu_Search_18_generate_neighbor_generate_neighbor(__pyx_self, __pyx_v_solution, __pyx_v_probability_change_machine, __pyx_v_dependency_matrix_index_encoding, __pyx_v_required_machine_matrix);
...
static PyObject *__pyx_pf_9Optimizer_11Tabu_Search_18_generate_neighbor_generate_neighbor(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_solution, double __pyx_v_probability_change_machine, __Pyx_memviewslice __pyx_v_dependency_matrix_index_encoding, __Pyx_memviewslice __pyx_v_required_machine_matrix) {
  ...
  __pyx_t_1 = __pyx_f_9Optimizer_11Tabu_Search_18_generate_neighbor_generate_neighbor(__pyx_v_solution, __pyx_v_probability_change_machine, __pyx_v_dependency_matrix_index_encoding, __pyx_v_required_machine_matrix, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
