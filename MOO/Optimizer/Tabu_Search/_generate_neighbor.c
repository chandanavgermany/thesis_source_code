...
#define __PYX_HAVE__Optimizer__Tabu_Search___generate_neighbor
#define __PYX_HAVE_API__Optimizer__Tabu_Search___generate_neighbor
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'Optimizer.Tabu_Search._generate_neighbor' */
...
static PyObject *__pyx_f_9Optimizer_11Tabu_Search_18_generate_neighbor_generate_neighbor(PyObject *, double, __Pyx_memviewslice, __Pyx_memviewslice, int, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "Optimizer.Tabu_Search._generate_neighbor"
extern int __pyx_module_is_main_Optimizer__Tabu_Search___generate_neighbor;
int __pyx_module_is_main_Optimizer__Tabu_Search___generate_neighbor = 0;

/* Implementation of 'Optimizer.Tabu_Search._generate_neighbor' */
...
static const char __pyx_k_required_machine_matrix[] = "required_machine_matrix";
static const char __pyx_k_Cannot_index_with_type_s[] = "Cannot index with type '%s'";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_probability_change_machine[] = "probability_change_machine";
...
static PyObject *__pyx_n_s_probability_change_machine;
...
static PyObject *__pyx_n_s_required_machine_matrix;
...
static PyObject *__pyx_pf_9Optimizer_11Tabu_Search_18_generate_neighbor_generate_neighbor(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_solution, double __pyx_v_probability_change_machine, __Pyx_memviewslice __pyx_v_dependency_matrix_index_encoding, __Pyx_memviewslice __pyx_v_required_machine_matrix, int __pyx_v_reschedule, int __pyx_v_preschedule_idle); /* proto */
...
/* "Optimizer/Tabu_Search/_generate_neighbor.pyx":10
...
static PyObject *__pyx_pw_9Optimizer_11Tabu_Search_18_generate_neighbor_1generate_neighbor(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_9Optimizer_11Tabu_Search_18_generate_neighbor_generate_neighbor(PyObject *__pyx_v_solution, double __pyx_v_probability_change_machine, __Pyx_memviewslice __pyx_v_dependency_matrix_index_encoding, __Pyx_memviewslice __pyx_v_required_machine_matrix, int __pyx_v_reschedule, int __pyx_v_preschedule_idle, CYTHON_UNUSED int __pyx_skip_dispatch) {
  __Pyx_memviewslice __pyx_v_result_operation_2d_array = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_operation = { 0, 0, { 0 }, { 0 }, { 0 } };
  Py_ssize_t __pyx_v_random_index;
  Py_ssize_t __pyx_v_lower_index;
  Py_ssize_t __pyx_v_upper_index;
  Py_ssize_t __pyx_v_placement_index;
  ...
  __Pyx_RefNannySetupContext("generate_neighbor", 0);

  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":13
 *                         int[:, ::1] dependency_matrix_index_encoding, int[:, ::1] required_machine_matrix,
 *                         int reschedule, int preschedule_idle):
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_solution, __pyx_n_s_operation_2d_array); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  ...
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_result_operation_2d_array = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":18
 ...
 * 
 */
  __pyx_v_lower_index = 0;

  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":19
 *     cdef double[::1] makespans
 *     lower_index = 0
 *     upper_index = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_upper_index = 0;

  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":21
 *     upper_index = 0
 * 
 *     while lower_index >= upper_index:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  while (1) {
    __pyx_t_6 = ((__pyx_v_lower_index >= __pyx_v_upper_index) != 0);
    if (!__pyx_t_6) break;

    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":23
 *     while lower_index >= upper_index:
 * 
 *         random_index = np.random.randint(0, result_operation_2d_array.shape[0])             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyInt_FromSsize_t((__pyx_v_result_operation_2d_array.shape[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_4 = NULL;
    __pyx_t_7 = 0;
    ...
    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":24
 * 
 *         random_index = np.random.randint(0, result_operation_2d_array.shape[0])
 *         operation = result_operation_2d_array[random_index]             # <<<<<<<<<<<<<<
 *         job_id = operation[0]
 ...
 */
    __pyx_t_10.data = __pyx_v_result_operation_2d_array.data;
    __pyx_t_10.memview = __pyx_v_result_operation_2d_array.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_10, 0);
    {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_random_index;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_result_operation_2d_array.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_result_operation_2d_array.strides[0];
...
__pyx_t_10.shape[0] = __pyx_v_result_operation_2d_array.shape[1];
__pyx_t_10.strides[0] = __pyx_v_result_operation_2d_array.strides[1];
    __pyx_t_10.suboffsets[0] = -1;

__PYX_XDEC_MEMVIEW(&__pyx_v_operation, 1);
    __pyx_v_operation = __pyx_t_10;
    __pyx_t_10.memview = NULL;
    __pyx_t_10.data = NULL;

    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":25
 *         random_index = np.random.randint(0, result_operation_2d_array.shape[0])
 *         operation = result_operation_2d_array[random_index]
 *         job_id = operation[0]             # <<<<<<<<<<<<<<
 *         sequence = operation[2]
 ...
 */
    __pyx_t_11 = 0;
    __pyx_v_job_id = (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_operation.data) + __pyx_t_11)) )));

    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":26
 *         operation = result_operation_2d_array[random_index]
 *         job_id = operation[0]
 *         sequence = operation[2]             # <<<<<<<<<<<<<<
 *         lower_index = random_index - 1
 ...
 */
    __pyx_t_12 = 2;
    __pyx_v_sequence = (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_operation.data) + __pyx_t_12)) )));

    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":27
 *         job_id = operation[0]
 *         sequence = operation[2]
 *         lower_index = random_index - 1             # <<<<<<<<<<<<<<
 *         while lower_index >= 0 and not (
 ...
 */
    __pyx_v_lower_index = (__pyx_v_random_index - 1);

    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":28
 *         sequence = operation[2]
 *         lower_index = random_index - 1
 *         while lower_index >= 0 and not (             # <<<<<<<<<<<<<<
 *                 result_operation_2d_array[lower_index, 0] == job_id and result_operation_2d_array[lower_index, 2] == sequence - 1):
 ...
 */
    while (1) {
      __pyx_t_13 = ((__pyx_v_lower_index >= 0) != 0);
      if (__pyx_t_13) {
      } else {
      ...
      /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":29
 *         lower_index = random_index - 1
 *         while lower_index >= 0 and not (
 *                 result_operation_2d_array[lower_index, 0] == job_id and result_operation_2d_array[lower_index, 2] == sequence - 1):             # <<<<<<<<<<<<<<
 *             lower_index -= 1
 * 
 */
      __pyx_t_14 = __pyx_v_lower_index;
      __pyx_t_15 = 0;
      __pyx_t_16 = (((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_result_operation_2d_array.data + __pyx_t_14 * __pyx_v_result_operation_2d_array.strides[0]) )) + __pyx_t_15)) ))) == __pyx_v_job_id) != 0);
      if (__pyx_t_16) {
      } else {
      ...
      __pyx_t_18 = 2;
      __pyx_t_16 = (((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_result_operation_2d_array.data + __pyx_t_17 * __pyx_v_result_operation_2d_array.strides[0]) )) + __pyx_t_18)) ))) == (__pyx_v_sequence - 1)) != 0);
      __pyx_t_13 = __pyx_t_16;
 ...
 */
      ...
      /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":30
 *         while lower_index >= 0 and not (
 *                 result_operation_2d_array[lower_index, 0] == job_id and result_operation_2d_array[lower_index, 2] == sequence - 1):
 *             lower_index -= 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_lower_index = (__pyx_v_lower_index - 1);
    }

    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":32
 *             lower_index -= 1
 * 
 *         lower_index = 0 if lower_index < 0 else lower_index + 1             # <<<<<<<<<<<<<<
 ...
 */
    if (((__pyx_v_lower_index < 0) != 0)) {
      __pyx_t_9 = 0;
    } else {
      __pyx_t_9 = (__pyx_v_lower_index + 1);
    }
    __pyx_v_lower_index = __pyx_t_9;

    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":33
 * 
 *         lower_index = 0 if lower_index < 0 else lower_index + 1
 *         upper_index = random_index + 1             # <<<<<<<<<<<<<<
 *         while upper_index < result_operation_2d_array.shape[0] and not (
 ...
 */
    __pyx_v_upper_index = (__pyx_v_random_index + 1);

    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":34
 *         lower_index = 0 if lower_index < 0 else lower_index + 1
 *         upper_index = random_index + 1
 *         while upper_index < result_operation_2d_array.shape[0] and not (             # <<<<<<<<<<<<<<
 *                 result_operation_2d_array[upper_index, 0] == job_id and result_operation_2d_array[upper_index, 2] == sequence + 1):
 ...
 */
    while (1) {
      __pyx_t_16 = ((__pyx_v_upper_index < (__pyx_v_result_operation_2d_array.shape[0])) != 0);
      if (__pyx_t_16) {
      } else {
        __pyx_t_6 = __pyx_t_16;
      ...
      /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":35
 *         upper_index = random_index + 1
 *         while upper_index < result_operation_2d_array.shape[0] and not (
 *                 result_operation_2d_array[upper_index, 0] == job_id and result_operation_2d_array[upper_index, 2] == sequence + 1):             # <<<<<<<<<<<<<<
 *             upper_index += 1
 * 
 */
      __pyx_t_19 = __pyx_v_upper_index;
      __pyx_t_20 = 0;
      __pyx_t_13 = (((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_result_operation_2d_array.data + __pyx_t_19 * __pyx_v_result_operation_2d_array.strides[0]) )) + __pyx_t_20)) ))) == __pyx_v_job_id) != 0);
      if (__pyx_t_13) {
      } else {
        __pyx_t_16 = __pyx_t_13;
        goto __pyx_L15_bool_binop_done;
      }
      __pyx_t_21 = __pyx_v_upper_index;
      __pyx_t_22 = 2;
      __pyx_t_13 = (((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_result_operation_2d_array.data + __pyx_t_21 * __pyx_v_result_operation_2d_array.strides[0]) )) + __pyx_t_22)) ))) == (__pyx_v_sequence + 1)) != 0);
      __pyx_t_16 = __pyx_t_13;
 ...
 */
      ...
      /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":36
 *         while upper_index < result_operation_2d_array.shape[0] and not (
 *                 result_operation_2d_array[upper_index, 0] == job_id and result_operation_2d_array[upper_index, 2] == sequence + 1):
 *             upper_index += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_upper_index = (__pyx_v_upper_index + 1);
    }

    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":38
 *             upper_index += 1
 * 
 *         if upper_index >= result_operation_2d_array.shape[0] - 1:             # <<<<<<<<<<<<<<
 ...
 *         else:
 */
    __pyx_t_6 = ((__pyx_v_upper_index >= ((__pyx_v_result_operation_2d_array.shape[0]) - 1)) != 0);
    if (__pyx_t_6) {

      /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":39
 * 
 *         if upper_index >= result_operation_2d_array.shape[0] - 1:
 *             upper_index = upper_index - 2             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
      __pyx_v_upper_index = (__pyx_v_upper_index - 2);
 ...
 */
    ...
    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":41
 *             upper_index = upper_index - 2
 *         else:
 *             upper_index = upper_index - 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":43
 *             upper_index = upper_index - 1
 * 
 *     result_operation_2d_array = np.delete(result_operation_2d_array, random_index, axis=0)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_delete); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_result_operation_2d_array, 2, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_8 = PyInt_FromSsize_t(__pyx_v_random_index); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  ...
  __Pyx_GOTREF(__pyx_t_8);
  if (PyDict_SetItem(__pyx_t_8, __pyx_n_s_axis, __pyx_int_0) < 0) __PYX_ERR(0, 43, __pyx_L1_error)
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_2, __pyx_t_8); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __PYX_XDEC_MEMVIEW(&__pyx_v_result_operation_2d_array, 1);
  __pyx_v_result_operation_2d_array = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":44
 * 
 *     result_operation_2d_array = np.delete(result_operation_2d_array, random_index, axis=0)
 *     placement_index = random_index             # <<<<<<<<<<<<<<
 *     while placement_index == random_index:
 ...
 */
  __pyx_v_placement_index = __pyx_v_random_index;

  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":45
 *     result_operation_2d_array = np.delete(result_operation_2d_array, random_index, axis=0)
 *     placement_index = random_index
 *     while placement_index == random_index:             # <<<<<<<<<<<<<<
 *         placement_index = np.random.randint(lower_index, upper_index + 1)
 ...
 */
  while (1) {
    __pyx_t_6 = ((__pyx_v_placement_index == __pyx_v_random_index) != 0);
    if (!__pyx_t_6) break;

    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":46
 *     placement_index = random_index
 *     while placement_index == random_index:
 *         placement_index = np.random.randint(lower_index, upper_index + 1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_random); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_randint); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyInt_FromSsize_t(__pyx_v_lower_index); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = PyInt_FromSsize_t((__pyx_v_upper_index + 1)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = NULL;
    __pyx_t_7 = 0;
    ...
    if (PyFunction_Check(__pyx_t_8)) {
      ...
      __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_8, __pyx_temp+1-__pyx_t_7, 2+__pyx_t_7); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 46, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_8)) {
      PyObject *__pyx_temp[3] = {__pyx_t_4, __pyx_t_2, __pyx_t_3};
      __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_8, __pyx_temp+1-__pyx_t_7, 2+__pyx_t_7); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 46, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    #endif
    {
      __pyx_t_23 = PyTuple_New(2+__pyx_t_7); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 46, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_23);
      if (__pyx_t_4) {
        __Pyx_GIVEREF(__pyx_t_4); PyTuple_SET_ITEM(__pyx_t_23, 0, __pyx_t_4); __pyx_t_4 = NULL;
      }
      __Pyx_GIVEREF(__pyx_t_2);
      PyTuple_SET_ITEM(__pyx_t_23, 0+__pyx_t_7, __pyx_t_2);
      __Pyx_GIVEREF(__pyx_t_3);
      PyTuple_SET_ITEM(__pyx_t_23, 1+__pyx_t_7, __pyx_t_3);
      __pyx_t_2 = 0;
      __pyx_t_3 = 0;
      __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_23, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 46, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
    }
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_9 = __Pyx_PyIndex_AsSsize_t(__pyx_t_1); if (unlikely((__pyx_t_9 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_v_placement_index = __pyx_t_9;
  }

  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":48
 *         placement_index = np.random.randint(lower_index, upper_index + 1)
 * 
 *     if np.random.random_sample() < probability_change_machine:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_23 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_random); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_23);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_23, __pyx_n_s_random_sample); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
  __pyx_t_23 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_8))) {
  ...
  __pyx_t_1 = (__pyx_t_23) ? __Pyx_PyObject_CallOneArg(__pyx_t_8, __pyx_t_23) : __Pyx_PyObject_CallNoArg(__pyx_t_8);
  __Pyx_XDECREF(__pyx_t_23); __pyx_t_23 = 0;
  if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = PyFloat_FromDouble(__pyx_v_probability_change_machine); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_23 = PyObject_RichCompare(__pyx_t_1, __pyx_t_8, Py_LT); __Pyx_XGOTREF(__pyx_t_23); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_6 = __Pyx_PyObject_IsTrue(__pyx_t_23); if (unlikely(__pyx_t_6 < 0)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
  if (__pyx_t_6) {

    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":49
 * 
 *     if np.random.random_sample() < probability_change_machine:
 *         i = dependency_matrix_index_encoding[operation[0], operation[1]]             # <<<<<<<<<<<<<<
 *         operation[3] = np.random.choice(required_machine_matrix[i])
 * 
 */
    if (unlikely(!__pyx_v_operation.memview)) { __Pyx_RaiseUnboundLocalError("operation"); __PYX_ERR(0, 49, __pyx_L1_error) }
    __pyx_t_24 = 0;
    if (unlikely(!__pyx_v_operation.memview)) { __Pyx_RaiseUnboundLocalError("operation"); __PYX_ERR(0, 49, __pyx_L1_error) }
    __pyx_t_25 = 1;
    __pyx_t_26 = (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_operation.data) + __pyx_t_24)) )));
    __pyx_t_27 = (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_operation.data) + __pyx_t_25)) )));
    __pyx_v_i = (*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_dependency_matrix_index_encoding.data + __pyx_t_26 * __pyx_v_dependency_matrix_index_encoding.strides[0]) )) + __pyx_t_27)) )));

    /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":50
 *     if np.random.random_sample() < probability_change_machine:
 *         i = dependency_matrix_index_encoding[operation[0], operation[1]]
 *         operation[3] = np.random.choice(required_machine_matrix[i])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_random); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 50, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_choice); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 50, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_10.data = __pyx_v_required_machine_matrix.data;
    __pyx_t_10.memview = __pyx_v_required_machine_matrix.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_10, 0);
    {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_i;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_required_machine_matrix.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_required_machine_matrix.strides[0];
    if (0 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (0 && !__Pyx_is_valid_index(__pyx_tmp_idx, __pyx_tmp_shape)) {
        PyErr_SetString(PyExc_IndexError, "Index out of bounds (axis 0)");
...
__pyx_t_10.shape[0] = __pyx_v_required_machine_matrix.shape[1];
__pyx_t_10.strides[0] = __pyx_v_required_machine_matrix.strides[1];
    __pyx_t_10.suboffsets[0] = -1;

__pyx_t_1 = __pyx_memoryview_fromslice(__pyx_t_10, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 50, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    ...
    __pyx_t_23 = (__pyx_t_3) ? __Pyx_PyObject_Call2Args(__pyx_t_8, __pyx_t_3, __pyx_t_1) : __Pyx_PyObject_CallOneArg(__pyx_t_8, __pyx_t_1);
    __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 50, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_23);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_7 = __Pyx_PyInt_As_int(__pyx_t_23); if (unlikely((__pyx_t_7 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 50, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
    if (unlikely(!__pyx_v_operation.memview)) { __Pyx_RaiseUnboundLocalError("operation"); __PYX_ERR(0, 50, __pyx_L1_error) }
    __pyx_t_28 = 3;
    *((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_operation.data) + __pyx_t_28)) )) = __pyx_t_7;
 ...
 */
  ...
  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":52
 *         operation[3] = np.random.choice(required_machine_matrix[i])
 * 
 *     return Solution(solution.data, np.insert(result_operation_2d_array,             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_23, __pyx_n_s_Solution); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_23);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_v_solution, __pyx_n_s_data); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_np); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_insert); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_result_operation_2d_array, 2, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);

  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":53
 * 
 *     return Solution(solution.data, np.insert(result_operation_2d_array,
 *                                              placement_index, operation, axis=0),             # <<<<<<<<<<<<<<
 *                                              reschedule=reschedule, preschedule_idle=preschedule_idle)
 */
  __pyx_t_2 = PyInt_FromSsize_t(__pyx_v_placement_index); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (unlikely(!__pyx_v_operation.memview)) { __Pyx_RaiseUnboundLocalError("operation"); __PYX_ERR(0, 53, __pyx_L1_error) }
  __pyx_t_4 = __pyx_memoryview_fromslice(__pyx_v_operation, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 53, __pyx_L1_error)
 ...
 *                                              reschedule=reschedule, preschedule_idle=preschedule_idle)
 */
  __pyx_t_29 = PyTuple_New(3); if (unlikely(!__pyx_t_29)) __PYX_ERR(0, 52, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_axis, __pyx_int_0) < 0) __PYX_ERR(0, 53, __pyx_L1_error)
 ...
 *                                              reschedule=reschedule, preschedule_idle=preschedule_idle)
 */
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_29, __pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":54
 *     return Solution(solution.data, np.insert(result_operation_2d_array,
 *                                              placement_index, operation, axis=0),
 *                                              reschedule=reschedule, preschedule_idle=preschedule_idle)             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v_reschedule); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_reschedule, __pyx_t_8) < 0) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v_preschedule_idle); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_preschedule_idle, __pyx_t_8) < 0) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
 ...
 *                                              reschedule=reschedule, preschedule_idle=preschedule_idle)
 */
  __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_23, __pyx_t_4, __pyx_t_2); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("Optimizer.Tabu_Search._generate_neighbor.generate_neighbor", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_result_operation_2d_array, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_operation, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_9Optimizer_11Tabu_Search_18_generate_neighbor_1generate_neighbor(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_9Optimizer_11Tabu_Search_18_generate_neighbor_1generate_neighbor(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_solution = 0;
  double __pyx_v_probability_change_machine;
  __Pyx_memviewslice __pyx_v_dependency_matrix_index_encoding = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_required_machine_matrix = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_reschedule;
  int __pyx_v_preschedule_idle;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("generate_neighbor (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_solution,&__pyx_n_s_probability_change_machine,&__pyx_n_s_dependency_matrix_index_encoding,&__pyx_n_s_required_machine_matrix,&__pyx_n_s_reschedule,&__pyx_n_s_preschedule_idle,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_probability_change_machine)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_neighbor", 1, 6, 6, 1); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dependency_matrix_index_encoding)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_neighbor", 1, 6, 6, 2); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_required_machine_matrix)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_neighbor", 1, 6, 6, 3); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_reschedule)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_neighbor", 1, 6, 6, 4); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_preschedule_idle)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_neighbor", 1, 6, 6, 5); __PYX_ERR(0, 10, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "generate_neighbor") < 0)) __PYX_ERR(0, 10, __pyx_L3_error)
      }
    ...
    __pyx_v_probability_change_machine = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_probability_change_machine == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_dependency_matrix_index_encoding = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_dependency_matrix_index_encoding.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_required_machine_matrix = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_required_machine_matrix.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_reschedule = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_reschedule == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_preschedule_idle = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_preschedule_idle == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("generate_neighbor", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("Optimizer.Tabu_Search._generate_neighbor.generate_neighbor", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9Optimizer_11Tabu_Search_18_generate_neighbor_generate_neighbor(__pyx_self, __pyx_v_solution, __pyx_v_probability_change_machine, __pyx_v_dependency_matrix_index_encoding, __pyx_v_required_machine_matrix, __pyx_v_reschedule, __pyx_v_preschedule_idle);
...
static PyObject *__pyx_pf_9Optimizer_11Tabu_Search_18_generate_neighbor_generate_neighbor(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_solution, double __pyx_v_probability_change_machine, __Pyx_memviewslice __pyx_v_dependency_matrix_index_encoding, __Pyx_memviewslice __pyx_v_required_machine_matrix, int __pyx_v_reschedule, int __pyx_v_preschedule_idle) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("generate_neighbor", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_dependency_matrix_index_encoding.memview)) { __Pyx_RaiseUnboundLocalError("dependency_matrix_index_encoding"); __PYX_ERR(0, 10, __pyx_L1_error) }
  if (unlikely(!__pyx_v_required_machine_matrix.memview)) { __Pyx_RaiseUnboundLocalError("required_machine_matrix"); __PYX_ERR(0, 10, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_9Optimizer_11Tabu_Search_18_generate_neighbor_generate_neighbor(__pyx_v_solution, __pyx_v_probability_change_machine, __pyx_v_dependency_matrix_index_encoding, __pyx_v_required_machine_matrix, __pyx_v_reschedule, __pyx_v_preschedule_idle, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_required_machine_matrix, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "Optimizer.Tabu_Search._generate_neighbor.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "Optimizer.Tabu_Search._generate_neighbor.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "Optimizer.Tabu_Search._generate_neighbor.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "Optimizer.Tabu_Search._generate_neighbor._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"generate_neighbor", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9Optimizer_11Tabu_Search_18_generate_neighbor_1generate_neighbor, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__generate_neighbor(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__generate_neighbor},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_probability_change_machine, __pyx_k_probability_change_machine, sizeof(__pyx_k_probability_change_machine), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_required_machine_matrix, __pyx_k_required_machine_matrix, sizeof(__pyx_k_required_machine_matrix), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_generate_neighbor(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_generate_neighbor(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__generate_neighbor(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__generate_neighbor(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__generate_neighbor(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_generate_neighbor' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__generate_neighbor(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_generate_neighbor", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_Optimizer__Tabu_Search___generate_neighbor) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Optimizer.Tabu_Search._generate_neighbor")) {
      if (unlikely(PyDict_SetItemString(modules, "Optimizer.Tabu_Search._generate_neighbor", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":1
 ...
 */
  ...
  /* "Optimizer/Tabu_Search/_generate_neighbor.pyx":3
 * from ..solution import Solution
 * cimport cython
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Optimizer.Tabu_Search._generate_neighbor", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init Optimizer.Tabu_Search._generate_neighbor");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
